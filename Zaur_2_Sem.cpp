...
// Zaur_2_Sem.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CZaur_2_SemApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CZaur_2_SemApp

CZaur_2_SemApp::CZaur_2_SemApp()
{
...
// Единственный объект CZaur_2_SemApp

CZaur_2_SemApp theApp;


// инициализация CZaur_2_SemApp

BOOL CZaur_2_SemApp::InitInstance()
{
